    ...
    <section className="flex flex-col items-end w-full select-none">
        ...
        <article className="flex flex-col lg:flex-row self-stretch lg:justify-end lg:items-end lg:gap-6">
            <div className="flex grow order-3 lg:order-none text-secondary-body gap-[60px] py-[10px] text-lg lg:text-[32px]">
                <Link href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-surface">
                    <BsInstagram/>
                </Link>
            ...
            <div className="flex flex-col items-end gap-4 lg:gap-[88px] order-2 lg:order-none">
                ...
                <div className="w-fit">
                    <h6 className="ui-2xl text-surface font-medium">
                        Portfolio
                    </h6>
                </div>
            </div>
